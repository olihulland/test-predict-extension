...
enum Classification {
  ...
  namespace ML_Movement {
    ...
    //% weight=60
    export function Circle_enum_const(): Classification {
      return 0;
    }
    ...
    //% group="Possible prediction output values"
    //% weight=60
    export function Holding_enum_const(): Classification {
      return 1;
    }
    ...
    //% group="Possible prediction output values"
    //% weight=60
    export function ZigZag_enum_const(): Classification {
      return 2;
    }
